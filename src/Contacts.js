    ...
    render(){
        return(
            <div className="contacts">
                ...
                <div className="contact-item"><AiFillLinkedin /> <a href="linkedin.com/in/elnur-hamidov-685737216" target="_blank" rel="noopener noreferrer">linkedin.com/in/elnur-hamidov-685737216</a></div>
